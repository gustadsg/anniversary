...
VirtualSky.prototype.drawImmediate = function(proj){
	...
	if(this.showposition){
		positionstring = Math.abs(this.latitude.deg).toFixed(5) + ((this.latitude.rad>0) ? this.getPhrase('N') : this.getPhrase('S')) + ', ' + Math.abs(this.longitude.deg).toFixed(5) + ((this.longitude.rad>0) ? this.getPhrase('E') : this.getPhrase('W'));
